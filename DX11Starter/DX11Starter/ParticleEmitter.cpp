...
void ParticleEmitter::CopyParticlesToGPU(ID3D11DeviceContext* context, Camera* camera)
{
...
void ParticleEmitter::CopyOneParticle(int index, Camera* camera)
{
	int i = index * 4;
...
XMFLOAT3 ParticleEmitter::CalcParticleVertexPosition(int particleIndex, int quadCornerIndex, Camera* camera)
{
	...
	// Since the UV's are already set when the ParticleEmitter is created, 
